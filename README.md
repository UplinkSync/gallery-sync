...
- **CI**: shared template from [`***`](https://***/***) — php lint, phpcs/phpunit via composer scripts, gitleaks secret scan, esbuild asset build, per-MR review app with the plugin active.
